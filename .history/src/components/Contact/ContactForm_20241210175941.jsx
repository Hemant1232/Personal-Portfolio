  ...
  return (
    <div className='mx-auto  flex flex-col mb-40 gap-12 w-9/12 '>
      ...
      <form className=' p-3 flex flex-col gap-8 ' action="">
        ...
        <div>
            <textarea className='w-full min-h-6 px-8 py-4 overflow rounded-3xl outline-none shadow-lg' name="" id="" cols={30} rows={10} placeholder='Hemant, Lets Grow Together !?'></textarea>
        </div>
