...
const ContactForm = () => {
  return (
    <div className='mx-auto border-2 flex flex-col gap-12 w-9/12 '>
      ...
      <form className='border-2 p-3 flex flex-col gap- ' action="">
        <div className='flex justify-between '>
            <div className=''>
                <input className='px-8 py-5 rounded-full outline-none ' type="text" placeholder='Your Good Name Here !' />
            </div>
            <span>
                <input className='px-5 py-3 rounded-full' type="email" placeholder='Insert Your Email' />
            </span>
        </div>
        <div>
        ...
        <div>
            <textarea className='w-full px-8 py-5 rounded-xl' name="" id="" cols={30} rows={10} placeholder='Hemant, Lets Grow Together !?'></textarea>
        </div>
