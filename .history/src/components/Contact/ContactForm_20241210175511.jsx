...
const ContactForm = () => {
  return (
    <div className='mx-auto  flex flex-col mb-40 gap-12 w-9/12 '>
      ...
      <form className=' p-3 flex flex-col gap-8 ' action="">
        ...
        <div>
            <input className='w-full px-8 py-5 rounded-full shadow-lg' type="text" placeholder='I have an IDEA !' />
        </div>
        <div>
            <textarea className='w-full px-8 py-5 rounded-3xl shadow-lg' name="" id="" cols={30} rows={10} placeholder='Hemant, Lets Grow Together !?'></textarea>
        </div>
        <button className="bg-first_color w-fit text-white font-semibold px-6 py-3 rounded-full text-lg">Send Message</button>
      </form>
      </div>
