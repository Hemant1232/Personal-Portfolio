...
const ContactForm = () => {
  return (
    <div className='mx-auto border-2 flex flex-col gap-12 w-9/12 '>
      ...
      <form className='border-2 p-3  ' action="">
        ...
        <div>
            <textarea className='w-full px-8 py-5 rounded-full' name="" id="" cols={30} rows={10} placeholder='Hemant, Lets Grow Together !?'></textarea>
        </div>
