    ...
    <div className='mx-auto border-2 flex flex-col gap-12 w-9/12 '>
      ...
      <form className='border-2 p-3 flex flex-col gap-4 ' action="">
        <div className='flex justify-around border-2'>
                ...
                <input className='px-8 py-5 w-[50%] rounded-full outline-none ' type="text" placeholder='Your Good Name Here !' />
           
                <input className='px-8 py-5 w-[50] rounded-full outline-none' type="email" placeholder='Insert Your Email' />
