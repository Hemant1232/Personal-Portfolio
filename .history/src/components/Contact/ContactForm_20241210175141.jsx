  ...
  return (
    <div className='mx-auto  flex flex-col gap-12 w-9/12 '>
      ...
      <form className=' p-3 flex flex-col gap-4 ' action="">
        <div className='flex justify-around 2'>
            
                <input className='px-8 py-5 w-[47%] rounded-full outline-none ' type="text" placeholder='Your Good Name Here !' />
           
                <input className='px-8 py-5 w-[47%] rounded-full outline-none' type="email" placeholder='Insert Your Email' />
