...
const Shapes = () => {
  return (
    <div className='absolute l-0 t-0 h-full w-full'>
        <svg
        width="27"
        height="29"
      ...
      <svg
        width="26"
        height="26"
        className='relative left-[20%] top-[30%]'
        class="shape s2"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="30"
        height="25"
        className=' relative left-[14%] bottom-[30%]'
        class="shape s3"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        ...
        height="23"
        class="shape s5"
        className=' relative left-[44%] top-[10%]'
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          transform="rotate(30 9.86603 10.13397)"
      ...
      <svg
        ...
        height="17"
        class="shape s6"
        className=' relative left-[36%] bottom-[10%]'
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        ...
        height="26"
        class="shape s7"
        className=' relative top-[20%] right-[25%]'
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        ...
        height="21"
        class="shape s8"
        className= ' relative right-[24%] bottom-[20%]'
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        ...
        height="29"
        class="shape s10"
        className=' relative top-[45%] right-[11%]'
        xmlns="http://www.w3.org/2000/svg"
      >
