...
const Home = () => {
  return (
    <div className='relative min-h-screen bg-slate-600 flex items-center justify-center flex-col'>
     ...
     <SocialLinks/>
     <a href="#contact" className="p-[0.75rem] px-[2rem] leading-none rounded-[1.875rem] shadow-[1.875rem] border-[1px] border-transparent text-white inline-block bg-[v font-bold">Hire Me</a>
     <ScrollDown/>
    </div>
  )
}
