      ...
      <div className="flex flex-row gap-3 mb-8">
        ...
        <div className="flex bg-[#fff] shadow-lg rounded-3xl   ">
          <div className="w-[50%] mx-5 leading-8 tracking-normal my-4 text-slate-700 text-base">
            ...
            <a href="https://drive.google.com/file/d/1yndHSlCbeA5KDsaZ7A8KcYh2nbyzJFz-/view?usp=drive_link" className="bg-first_color text-white font p-3 rounded-xl" download={"Hemant's Resume"}>Download Resume</a>
          </div>
