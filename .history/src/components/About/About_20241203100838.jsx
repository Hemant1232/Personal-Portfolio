    ...
    <section className=" relative flex flex-col mx-[14%] my-[7%] ">
      ...
      <div className="flex flex-row gap-3 mb-8">
        ...
        <div className="flex bg-[#fff] shadow-lg rounded-3xl   ">
          <div className="relative mb-10 w-[50%] mx-5 leading-8 tracking-normal my-4 text-slate-700 text-base">
            <p>
              I am eager to pursue a dynamic career in IT, leveraging my
              software development and UX design skills in challenging and
              innovative projects.
            </p>
            <a href="https://drive.google.com/file/d/1yndHSlCbeA5KDsaZ7A8KcYh2nbyzJFz-/view?usp=drive_link" className="bg-first_color text-white font-semibold px-6 py-3 rounded-full" download={"Hemant's Resume"}>Download Resume</a>
          </div>
