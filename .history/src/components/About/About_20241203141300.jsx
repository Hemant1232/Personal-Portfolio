    ...
    <section className=" relative flex flex-col mx-[14%] my-[7%] ">
      ...
      <div className="flex flex-row gap-3 mb-8">
        ...
        <div className="flex bg-[#fff] shadow-lg rounded-3xl   ">
          <div className="relative flex flex-col justify-start gap w-[50%] mx-5 leading-8 tracking-normal my-4 text-slate-700 text-base">
            <p>
            ...
            <a
              ...
              className="bg-first_color w-fit text-white font-semibold px-6 py-3 rounded-full"
