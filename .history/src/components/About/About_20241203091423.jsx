  ...
  return (
    <section className=" relative flex flex-col mx-[14%] my-[7%] ">
      ...
      <div className="flex flex-row gap-3">
        ...
        <div className="h-5 w-7  transform rotate-45 translate-x-[22px] translate-y-6 border-1  "></div>
        <div className="flex border-2 border-black rounded-3xl  ">
          ...
          <div className="w-[40%] flex flex-col gap-3 mt ">
            <div>
              <div>
                <h3>Development</h3>
                <span>90%</span>
            ...
            <div>
              ...
              <div className="h-[7px] bg-[#f1f1f1] rounded-[0.25rem]">
                <div className=" h-[7px] block bg-[#FF4C60]  w-[90%] rounded-[0.25rem]"></div>
              </div>
            </div>
            <div>
              <div>
              ...
              <div className="h-[7px] bg-[#f1f1f1] rounded-[0.25rem]">
                <div className=" h-[7px] block bg-[#6C6CC7]  w-[90%] rounded-[0.25rem]"></div>
              </div>
            </div>
          </div>
        </div>
