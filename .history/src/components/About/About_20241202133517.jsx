  ...
  return (
    <section className= " relative flex flex-col mx-[14%] my-[7%] ">
      ...
      <img className="w-60 h-[230px]" src="https://i.ibb.co/k89WFzY/about-us-pic.png" alt="" />
        ...
        <div className="h-5 w-7 transform rotate-45 translate-x-[22px] translate-y-6 border-1 bg-white  "></div>
      <div className="flex   rounded-3xl drop-shadow-lg ">
        ...
        <div>
          <div>
            ...
            <div className="h-[7px] bg-[#f1f1f1] rounded-[0.25r]">
            <div className="block bg-first_color w-[90%] rounded-md"> Bar Chart</div>
            </div>
          </div>
          <div>
            <div>
